...
@section('content')
    ...
    @if ($errors->any())
        <div class="alert alert-danger">
            <strong>Whoops!</strong>Er was een foutmelding met je post.<br><br>
            <ul>
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <textarea class="form-control" style="height:150px" name="detail" placeholder="Beschrijving">{{ $product->detail }}</textarea>
                </div>
            </div>
